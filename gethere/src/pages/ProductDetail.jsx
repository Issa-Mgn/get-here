...
export default function ProductDetail() {
  ...
  const productSchema = {
    ...
    offers: {
      ...
      seller: { "@type": "Organization", name: "GetHere" },
    },
    ...(product.rating ? { aggregateRating: {
  ...
  return (
    <main className="detail-page">
      <SEO
        ...
        description={`${product.name} : ${product.description} Livraison partout au Bénin avec GetHere.`}
        image={product.image}
        type="product"
