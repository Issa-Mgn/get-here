...
export default function Home() {
  ...
  return (
    <main className="home">
      ...
      {/* ══ HERO — hero.png plein écran, image entière visible ══ */}
      <section className="hero">
        {/* Image desktop */}
        <img src={heroBg} alt="GetHere" className="hero__img hero__img--desktop" />
        {/* Image mobile — taille naturelle préservée */}
        ...
        <div className="hero__content">
          ...
          <p className="hero__desc">
            Tout ceux dont vous avez besoin, en un seul endroit.
          </p>
          ...
          <div className="hero__stats">
            <div className="hero__stat"><strong>200+</strong><span>Produits</span></div>
            <div className="hero__stat-divider" />
            <div className="hero__stat"><strong>6</strong><span>Catégories</span></div>
            <div className="hero__stat-divider" />
      ...
      {/* ══ PROMO — carrousel images + texte côte à côte ══ */}
        ...
        <section className="promo-img-section">
          ...
          <div className="promo-dots">
            {PROMO_SLIDES.map((_, i) => (
              <button
                key={i}
                className={`promo-dot ${i === promoSlide ? "is-active" : ""}`}
      ...
      <section className="cta-final">
        <div className="cta-final__inner">
          ...
          <a
            href="https://wa.me/2290129140143?text=Bonjour%20GetHere%20!%20Je%20veux%20passer%20une%20commande%20%F0%9F%98%8A"
            target="_blank" rel="noreferrer"
            className="btn-solid btn-solid--lg"
          >
